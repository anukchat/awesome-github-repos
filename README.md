...
- [Large Language Models (LLMs)](#largelanguagemodelsllms)
- [LLMOps & Deployment](#llmopsdeployment)
- [AI Agents & Multi-Agent Systems](#aiagentsmultiagentsystems)
- [Prompt Engineering](#promptengineering)
- [Retrieval-Augmented Generation (RAG)](#retrievalaugmentedgenerationrag)
- [Model Context Protocol (MCP)](#modelcontextprotocolmcp)
- [AI Frameworks & Toolkits](#aiframeworkstoolkits)
- [AI Automation & Workflow Tools](#aiautomationworkflowtools)
- [Conversational AI & Chatbots](#conversationalaichatbots)
- [Computer Vision & Image Generation](#computervisionimagegeneration)
- [Speech & Audio (TTS, ASR, Music)](#speechaudiottsasrmusic)
- [Robotics & Embodied AI](#roboticsembodiedai)
- [Machine Learning (Traditional)](#machinelearningtraditional)
- [MLOps & ML Infrastructure](#mlopsmlinfrastructure)
- [AI in Education & Courses](#aiineducationcourses)
- [AI Testing & Evaluation](#aitestingevaluation)
- [Natural Language Processing (NLP)](#naturallanguageprocessingnlp)
- [AI UX/UI Design & Interaction](#aiuxuidesigninteraction)
- [Generative AI](#generativeai)
- [Data Engineering & Pipelines](#dataengineeringpipelines)
- [Knowledge Management & Graphs](#knowledgemanagementgraphs)
- [Low-Code / No-Code AI Tools](#lowcodenocodeaitools)
- [Web Scraping & Automation](#webscrapingautomation)
- [System & Software Design](#systemsoftwaredesign)
- [DevOps & Cloud Infrastructure](#devopscloudinfrastructure)
- [Productivity & Developer Tools](#productivitydevelopertools)
- [Search & Indexing Tools](#searchindexingtools)
- [Finance & Quantitative Tools](#financequantitativetools)
- [IoT & Edge AI](#iotedgeai)
- [Awesome Lists & Aggregators](#awesomelistsaggregators)
- [Others](#others)

---

<h2 id="largelanguagemodelsllms">Large Language Models (LLMs)</h2>
<p><i>Pretrained/fine-tuned models, inference engines, model recipes, optimization.</i></p>
<details><summary>Show repositories (29)</summary>
...
`asr` `deeplearning` `generative-ai` `large-language-models` `machine-translation`
...
`deep-learning` `inference` `llm` `nlp` `pytorch`
...
<h2 id="llmopsdeployment">LLMOps & Deployment</h2>
<p><i>Infrastructure, orchestration, serving, routing, monitoring for LLMs.</i></p>
...
`ai-gateway` `gateway` `generative-ai` `hacktoberfest` `langchain`
...
`ai` `ai-engineering` `anthropic` `artificial-intelligence` `deep-learning`
...
<h2 id="aiagentsmultiagentsystems">AI Agents & Multi-Agent Systems</h2>
<p><i>Autonomous agents, agent orchestration, frameworks, agent education.</i></p>
<details><summary>Show repositories (73)</summary>
...
`agent` `ai` `aiagent` `application` `chatbots`
...
`agentic-ai` `agents` `ai` `autonomous-agents` `deepseek-r1`
...
`alpha-evolve` `alphacode` `alphaevolve` `coding-agent` `deepmind`
...
`agents` `langgraph` `llms` `multiagent` `multiagent-systems`
...
<h2 id="promptengineering">Prompt Engineering</h2>
<p><i>Prompt tuning, optimization, system prompts, evaluation guides.</i></p>
<details><summary>Show repositories (7)</summary>
...
<h2 id="retrievalaugmentedgenerationrag">Retrieval-Augmented Generation (RAG)</h2>
<p><i>RAG frameworks, pipelines, vector DB integration, hybrid search systems.</i></p>
...
`aceternity-ui` `agent` `agents` `ai` `chrome-extension`
...
<h2 id="modelcontextprotocolmcp">Model Context Protocol (MCP)</h2>
<p><i>Tools, clients, servers, and implementations for managing model context.</i></p>
<details><summary>Show repositories (25)</summary>
...
### <img src="https://avatars.githubusercontent.com/u/120314019?v=4" width="20" align="top" alt="metorial"/> [metorial/mcp-containers](https://github.com/metorial/mcp-containers) 🔥

> Containerized versions of hundreds of MCP servers 📡 🧠

<div align="center">

[![Stars](https://img.shields.io/github/stars/metorial/mcp-containers?style=flat-square&labelColor=343b41)](https://github.com/metorial/mcp-containers/stargazers) [![Forks](https://img.shields.io/github/forks/metorial/mcp-containers?style=flat-square&labelColor=343b41)](https://github.com/metorial/mcp-containers/network/members) [![Last Commit](https://img.shields.io/github/last-commit/metorial/mcp-containers?style=flat-square&labelColor=343b41)](https://github.com/metorial/mcp-containers/commits)

</div>

`agent` `agentic-ai` `agentic-workflow` `container` `docker`
...
`api` `async` `asyncio` `fastapi` `framework`
...
<h2 id="aiautomationworkflowtools">AI Automation & Workflow Tools</h2>
<p><i>Workflow engines, automation platforms, RPA systems powered by AI.</i></p>
<details><summary>Show repositories (19)</summary>
...
`automation` `automatisch` `low-code` `no-code` `open-source`
...
<h2 id="conversationalaichatbots">Conversational AI & Chatbots</h2>
<p><i>Frameworks or UIs for chat agents, voice-based interfaces, open chat UIs.</i></p>
<details><summary>Show repositories (10)</summary>
...
<h2 id="computervisionimagegeneration">Computer Vision & Image Generation</h2>
<p><i>Vision models, image editing, Stable Diffusion tools, multimodal setups.</i></p>
...
`chatocr` `chineseocr` `crnn` `db` `document-parsing`
...
<h2 id="speechaudiottsasrmusic">Speech & Audio (TTS, ASR, Music)</h2>
<p><i>Text-to-speech, speech-to-text, music generation, audio processing.</i></p>
<details><summary>Show repositories (10)</summary>
...
`asr` `automatic-speech-recognition` `conformer` `e2e-models` `production-ready`
...
<h2 id="roboticsembodiedai">Robotics & Embodied AI</h2>
<p><i>Robotics platforms, AI for robotics, humanoid or autonomous systems.</i></p>
<details><summary>Show repositories (12)</summary>
...
<h2 id="machinelearningtraditional">Machine Learning (Traditional)</h2>
<p><i>Non-LLM ML projects, courses, guides, systems design.</i></p>
...
<h2 id="mlopsmlinfrastructure">MLOps & ML Infrastructure</h2>
<p><i>Tools for ML pipelines, CI/CD, experimentation, cloud ML infra.</i></p>
...
<h2 id="aiineducationcourses">AI in Education & Courses</h2>
<p><i>Bootcamps, lecture notes, LLM/ML tutorials, beginner guides.</i></p>
<details><summary>Show repositories (53)</summary>
...
<h2 id="aitestingevaluation">AI Testing & Evaluation</h2>
<p><i>Tools or frameworks for model testing, hallucination detection, safety.</i></p>
<details><summary>Show repositories (11)</summary>
...
<h2 id="naturallanguageprocessingnlp">Natural Language Processing (NLP)</h2>
<p><i>Language understanding, transformers, tokenizers, datasets.</i></p>
<details><summary>Show repositories (5)</summary>
...
<h2 id="aiuxuidesigninteraction">AI UX/UI Design & Interaction</h2>
<p><i>Web/Desktop interfaces for AI tools, UI component generation, agent UI.</i></p>
<details><summary>Show repositories (22)</summary>
...
`cursor` `cursor-ai` `design` `design-to-code` `drizzle`
...
<h2 id="generativeai">Generative AI</h2>
<p><i>Image, video, podcast, music generation using AI.</i></p>
<details><summary>Show repositories (5)</summary>
...
<h2 id="dataengineeringpipelines">Data Engineering & Pipelines</h2>
<p><i>ETL tools, doc parsers, enrichment tools, structured input generators.</i></p>
<details><summary>Show repositories (8)</summary>
...
`agents` `data` `data-pipelines` `document-processing` `elt`
...
<h2 id="knowledgemanagementgraphs">Knowledge Management & Graphs</h2>
<p><i>Semantic search, AI memory, graph systems, Q&A layers.</i></p>
<details><summary>Show repositories (2)</summary>
...
<h2 id="lowcodenocodeaitools">Low-Code / No-Code AI Tools</h2>
<p><i>Platforms for visual programming, app building with minimal code.</i></p>
...
<h2 id="webscrapingautomation">Web Scraping & Automation</h2>
<p><i>Crawlers, browser automation, task schedulers, data collectors.</i></p>
<details><summary>Show repositories (11)</summary>
...
`distributed-scraper` `distributed-scraping` `golang` `google-maps` `google-maps-scraping`
...
<h2 id="systemsoftwaredesign">System & Software Design</h2>
<p><i>Resources and examples on low-level and high-level system design.</i></p>
<details><summary>Show repositories (11)</summary>
...
`architecture` `distributed-systems` `engineering` `interview` `interview-preparation`
...
`design` `design-patterns` `development` `interview` `interview-preparation`
...
<h2 id="devopscloudinfrastructure">DevOps & Cloud Infrastructure</h2>
<p><i>Self-hosting, deployment frameworks, containerized AI setups.</i></p>
<details><summary>Show repositories (10)</summary>
...
<h2 id="productivitydevelopertools">Productivity & Developer Tools</h2>
<p><i>Resume builders, markdown tools, GitHub UIs, icon generators.</i></p>
<details><summary>Show repositories (8)</summary>
...
<h2 id="searchindexingtools">Search & Indexing Tools</h2>
<p><i>Local search, search engine clones, AI-enhanced discovery.</i></p>
<details><summary>Show repositories (3)</summary>
...
<h2 id="financequantitativetools">Finance & Quantitative Tools</h2>
<p><i>Tools for trading, analysis, hedge funds, forecasting.</i></p>
<details><summary>Show repositories (3)</summary>
...
`algorithmic-trading` `auto-quant` `deep-learning` `finance` `fintech`

</details>

---

<h2 id="iotedgeai">IoT & Edge AI</h2>
<p><i>Projects combining AI with IoT, edge compute, ESP32-based systems.</i></p>
<details><summary>Show repositories (2)</summary>
...
<h2 id="awesomelistsaggregators">Awesome Lists & Aggregators</h2>
<p><i>Curated resources, educational repositories, prompt or tool collections.</i></p>
<details><summary>Show repositories (40)</summary>
...
`markdown` `presentation` `slides` `vite` `vue`
...
`cloud` `cloud-os` `cloud-storage` `desktop` `desktop-environment`
